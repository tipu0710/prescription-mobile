...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginParams&&(identical(other.credential, credential) || other.credential == credential)&&(identical(other.password, password) || other.password == password));
}
...
@override
String toString() {
  return 'LoginParams(credential: $credential, password: $password)';
}
...
class _LoginParams implements LoginParams {
   _LoginParams({required this.credential, required this.password});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginParams&&(identical(other.credential, credential) || other.credential == credential)&&(identical(other.password, password) || other.password == password));
}
